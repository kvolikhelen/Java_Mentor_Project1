...
public class NumsDivisibleBy3_5_15 {
...
/*
   ...
   if the number can be divisible by 3 but cannot be divisible by 15, then it should be only displayed in DivisibleBy3 section
